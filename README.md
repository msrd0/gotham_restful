...
```
 ...
 [__link12]: https://docs.rs/gotham_restful/0.6.7/gotham_restful/?search=gotham_restful::endpoint::Endpoint
 [__link13]: https://docs.rs/gotham_restful/0.6.7/gotham_restful/?search=gotham_restful::endpoint::EndpointWithSchema
 [__link2]: https://doc.rust-lang.org/stable/std/?search=std::string::String
 [__link3]: https://docs.rs/gotham_restful/0.6.7/gotham_restful/?search=gotham_restful::types::RequestBody
 ...
 [__link6]: https://crates.io/crates/serde_json/1.0.79
 [__link7]: https://docs.rs/gotham_restful/0.6.7/gotham_restful/?search=gotham_restful::response::Response::header
 [__link8]: https://docs.rs/gotham_restful/0.6.7/gotham_restful/?search=gotham_restful::cors::CorsRoute
