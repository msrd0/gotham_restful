...
const REDOC_URL = "https://cdn.jsdelivr.net/npm/redoc@2.0.0-rc.66/bundles/redoc.standalone.js";
const REDOC_SRI = "hlqNHWguYXVY8xl1jj+GL5NmOGgUwiV9wOudLJRBLW6wEwCYMtXJ/gPz+fL45Svtw++TJ+f0OuIPtX5i/+Gv9w==";
