...
const REDOC_URL = "https://cdn.jsdelivr.net/npm/redoc@2.0.0-rc.55/bundles/redoc.standalone.js";
const REDOC_SRI = "dsK4t5Xaixy+xCByBcAD6LdcsKoAaPchTfO/9k+iOn/b/EaHB5jei0j5ce/WEkdSjEZZNVMnFXM66CjcrsPfMA==";
